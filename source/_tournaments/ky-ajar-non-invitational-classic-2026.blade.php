---
eventId: 8
title: 'KY Ajar Non-Invitational Classic'
gameFormat: '4SS, G/60;+30'
...
@section('body')
    <h3>Welcome To Washbear Chess Club! 🦝♟️♣️</h3>
    <p>It's not the Open. It's not the Closed. It's... its own thing.</p>
    <p>Two days! Four rounds! Take your time and play your best.</p>
    ...
    <p>$200 in prizes based on 12 entries.</p>
    <ul>
        <li>1st Place Open: $100</li>
        <li>1st Place U1400: $100</li>
    </ul>
    ...
    <p>Last updated June 20, 2026. <a href="#online-registration">Add your name to the list!</a></p>
...
@section('entry-form')
    ...
    <p class="bg-gray-100 mx-auto w-full flex justify-center p-4 lg:w-1/2 lg:rounded-xl shadow-lg shadow-gray-500 mb-8">
        <iframe 
            src="https://docs.google.com/forms/d/e/1FAIpQLSdGsvemBo-HNaF8lhvsIkd-oThhpeWygza9HCrv_RfyFwqooQ/viewform?embedded=true" 
            width="640" 
            height="918" 
...
@section('secondary-body')
    ...
    <p>Chess Education Foundation maintains an assortment of snacks and drinks available for sale.</p>

    <h2 id-"post-tournament">Post-Tournament Hangout</h2>
    <p>Sunday evening, all players and friends are invited for dinner/drinks after the tournament.</p>
    <address class="block">
        El Nopal<br/>
    ...
    <p>We'll be organizing a pizza delivery on Saturday: choose from cheese, pepperoni, or mushroom. Purchase by the slice during registration.</p>
    <p>$2 per slice.</p>
    <p>No lunch provided on Sunday.</p>
