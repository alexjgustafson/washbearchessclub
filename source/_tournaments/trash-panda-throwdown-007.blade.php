...
@section('body')
    ...
    <p>Washbear goes where others fear to tread: slow time controls.</p>
    <p>Let three rounds of 60+30 deepen your soul and your chess game.</p>
    ...
    <p>$120 in prizes based on 12 entries.</p>
    <ul>
    ...
    <p>Last updated August 26, 2026 8:14am. <a href="#online-registration">Add your name to the list!</a></p>
    ...
    @include('_components.registration-table', ['registrations' => [
        ...
        [
            'name'   => 'Stephanie Dorelle Manning',
            'id'     => '33137895',
            'rating' => 'Unrated',
        ],
    ]])
...
@section('secondary-body')
    ...
    <p>We'll be organizing a pizza delivery: choose from cheese, pepperoni, or mushroom. Purchase by the slice during registration.</p>
    <p>$2 per slice.</p>
