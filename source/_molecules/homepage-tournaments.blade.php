<div class="py-8 mb-8 text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 px-8 py-8 md:px-16">
        <div>
            @img([
                'src' => 'trash-panda-throwdown-001-round-2-closeup.webp',
        ...
        <div>
            @img([
                'src' => 'trash-panda-throwdown-002-blitz.webp',
                'class' => 'h-auto max-w-full rounded-lg',
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 px-8 py-8 md:px-16">
        <div>
            @img([
                'src' => 'trash-panda-throwdown-002-full.webp',
                'class' => 'h-auto max-w-full rounded-lg',
        ...
        <div>
            @img([
                'src' => 'trash-panda-throwdown-001-winner.webp',
                'class' => 'h-auto max-w-full rounded-lg',
